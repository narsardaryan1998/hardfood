...
function setCookie(name, value, options = {path: '/', secure: true, 'max-age': 3600}) {
  if (options.expires) {
...
window.addEventListener('load', function() {
    ingEvents.init({});
   	let eventLogin = getCookie('loginEvent');
    
      if (eventLogin == 1 ){
        ingEvents.Event({category:'forms', action:'submit', label:'reg_snd', ya_label:'reg_snd', goalParams :{}});    	
        setCookie("loginEvent", 0);
      }      
