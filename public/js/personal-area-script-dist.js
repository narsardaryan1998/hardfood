...
var app = new Vue({
    ...
    data: {
        ...
        loadingForUpdateUserDetail: false,
        userNameOld: '',
        emailOld: '',
        dateOfBirthdayOld: '',
        userData: {
    ...
    methods: {
        ...
        addNewAddress() {
            ...
            this.$set(this.addressFormRequiredFields, 'addressStreet', false)
            if (!this.newAddress.addressStreet) {
                this.$set(this.addressFormRequiredFields, 'addressStreet', true)
            ...
            axios({
                ...
                url: "/api/address/add",
                params: {
                    params: this.newAddress,
                }
            }).then(response => {
                if (response.data.success) {
                    this.modalAction('address-success-added', 'add-addres')
                    this.getUser();
                    this.addAddressLoading = false;
        ...
        getUser() {
            axios({
                ...
                if (response.data) {
                    ...
                    this.$set(this.userData, 'dateOfBirthday', response.data.dateOfBirthday ? response.data.dateOfBirthday : '')
                    ...
                    this.userNameOld = response.data.name ? response.data.name : '';
                    this.emailOld = response.data.email ? response.data.email : '';
                    this.dateOfBirthdayOld = response.data.dateOfBirthday ? response.data.dateOfBirthday : '';
                }
                this.userRes = true;
            });
        },
        ...
        updateUserDetails() {
            this.loadingForUpdateUserDetail = true;
            axios({
                method: "post",
                url: "/api/update-user-detail",
                params: {
                    params: {
                        name: this.userNameOld,
                        email: this.emailOld,
                        dateOfBirthday: this.dateOfBirthdayOld,
                    },
                }
            }).then(response => {
                if (response.data.success) {
                    this.loadingForUpdateUserDetail = false;
                    this.getUser();
                }
            })
