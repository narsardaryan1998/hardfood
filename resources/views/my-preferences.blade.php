...
<head>
    ...
    <link rel="canonical" href="https://otbabuli.com/personal-area/my-preferences"/>
    <meta property="og:title" content="Мои предпочтения - Личный кабинет | otbabuli.com"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="otbabuli.com"/>
    <meta property="og:url" content="https://otbabuli.com/personal-area/my-preferences"/>
    ...
    <title>Мои предпочтения - Личный кабинет | otbabuli.com</title>
</head>

<body>
@include('inc.preloader')
<div class="my-preferences-app">
    @include('inc.loading')
    <div class="wrapper">
        <div class="conteiner">
            <div class="header">
            ...
            @include('inc.personal-area-my-preferences.index')
            @include('inc.footer')
            @include('inc.personal-area-my-preferences.popap')
...
<script src="/js/my-preferences-script-dist.js?ver=1100064"></script>
