...
<head>
    ...
    <link rel="canonical" href="https://otbabuli.com/personal-area/bonuses"/>
    <meta property="og:title" content="Бонусы - Личный кабинет | otbabuli.com"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="otbabuli.com"/>
    <meta property="og:url" content="https://otbabuli.com/personal-area/bonuses"/>
    ...
    <title>Бонусы - Личный кабинет | otbabuli.com</title>
</head>

<body>
@include('inc.preloader')
<div class="bonuses-app">
    @include('inc.loading')
    <div class="wrapper">
        <div class="conteiner">
            <div class="header">
            ...
            @include('inc.personal-area-bonuses.index')
            @include('inc.footer')
            @include('inc.personal-area-bonuses.popap')
...
<script src="/js/bonuses-script-dist.js?ver=1100064"></script>
