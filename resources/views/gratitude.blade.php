...
<div class="wrapper gratitude-app">
    <div class="conteiner">
        <div class="header">
            @include('inc.header_menu')
        </div>
        <main class="content" style="margin-top: 170px;">
            <div class="content__body">
                <div class="content__title title-content">
                    <div class="title-content__text">Спасибо за заказ!</div>
                    <div class="title-content__icon">
