...
<div class="sale900-app">
    @include('inc.loading')
    <div class="wrapper">
        <div class="conteiner">
            @include('inc.header-sale900')
            <div class="content">
...
<script src="/js/sale900-script-dist.js?ver=1100064"></script>
