...
<head>
    ...
    <link rel="canonical" href="https://hardfood.ru/personal-area/orders"/>
    <meta property="og:title" content="Заказы - Личный кабинет | hardfood.ru"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="hardfood.ru"/>
    <meta property="og:url" content="https://hardfood.ru/personal-area/orders"/>
...
<div class="orders-app">
    ...
    <div class="wrapper">
        <div class="conteiner">
            ...
            @include('inc.personal-area-orders.index')
            @include('inc.footer')
            @include('inc.personal-area-orders.popap')
