<div id="add-addres" class="popap _add-addres">
            ...
            <form action="#" target="frame">
                <div class="_labal-container">
                    <div style="position: relative">
                        <textarea class="add-addres__textarea default-text-color"
                                  v-model="newAddress.addressStreet"
                                  @focusin="openSuggestions = true"
                                  @focusout="openSuggestions = false"
                                  autocomplete="new-password"
                                  :class="{'validation-error':addressFormRequiredFields.addressStreet}"></textarea>
                        <label>Введи улицу и дом</label>
                        <div class="suggestions"
                             :class="{'suggestions__open': openSuggestions && newAddress.addressStreet}">
                            <div v-if="addressResults.length">
                                <button type="button" class="suggestion" v-for="address in addressResults"
                                        @click="newAddress.addressStreet = address">
                                    @{{ address }}
                                </button>
                            </div>
                            <div v-else>
                                <button class="suggestion">
                                    Такой адрес не найдено :(
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="add-addres__inputs">
                    <div class="_labal-container">
                        <input type="text"
                               class="add-addres__input default-text-color"
                               name="porch"
                    ...
                    <div class="_labal-container">
                        <input type="text" class="add-addres__input default-text-color" name="flat"
                               v-model="newAddress.addressFlat">
                        <label> Квартира </label>
                    </div>
                    <div class="_labal-container">
                        <input type="text" class="add-addres__input default-text-color" name="intercom"
                               v-model="newAddress.addressIntercom">
                        <label> Домофон </label>
                    </div>
                </div>
                <button type="button" disabled class="add-addres__btn" v-if="addAddressLoading">Сохранить</button>
                <button type="button" class="add-addres__btn close-popap" v-else @click="addNewAddress">Сохранить
                </button>
            </form>
        </div>
    </div>
    ...
    <div class="popap__body">
        <div class="popap__content">
            ...
            <form action="#" target="frame">
                ...
                <div class="add-addres__inputs">
                    <div class="_labal-container">
                        <input type="text" class="add-addres__input" name="porch" v-model="updatedAddress.addressPorch">
                        <label> Подъезд </label>
                    </div>
                    <div class="_labal-container">
                        <input type="text" class="add-addres__input" name="floor" v-model="updatedAddress.addressFloor">
                        <label> Этаж </label>
                    </div>
                    <div class="_labal-container">
                        <input type="text" class="add-addres__input" name="flat" v-model="updatedAddress.addressFlat">
                        <label> Квартира </label>
                    </div>
                    <div class="_labal-container">
...
<div id="chenge-order" class="popap chenge-order">
    <div class="popap__body">
        <div class="popap__content">
            ...
            <iframe style="display: none;" name="frame"></iframe>
            <div v-if="cart[changingOrderIndex]" class="chenge-order__form">
                <form action="#" target="frame">
                    <div class="_labal-container">
...
<div id="dish-rating" class="popap _dish-rating">
    <div class="popap__body">
        <div class="popap__content">
            <a href="#" class="popap__close close-popup">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="popap__title">
                Сливочно-пшенная каша с черной смородиной
            </div>
            <div class="_dish-rating__dish_image_and_rating">
                ...
                <div class="_dish-rating__rating forDesktop">
                    ...
                    <star-rating :animate="true" :rounded-corners="true" increment="0.5" star-size="20" active-color="#3AAE11" border-color="#3AAE11" v-model="rating"></star-rating>
                </div>
            </div>
            <div class="_dish-rating__info">
                Завтрак <span class="opsty_4">405 Ккал Б28 Ж19 У31</span>
            </div>
            <div class="_dish-rating__description">
                Состав блюда: <span class="opsty_4">Фетучини, курица, соус</span>
            </div>
            <div class="_dish-rating__dish_image_and_rating forMobile">
                <div class="_dish-rating__rating">
                    <div class="_dish-rating__rating__header">
                        Оцените блюдо:
                    </div>
                    <star-rating :animate="true" :rounded-corners="true" increment="0.5" star-size="20" active-color="#3AAE11" border-color="#3AAE11" v-model="rating"></star-rating>
