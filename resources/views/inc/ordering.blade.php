        ...
        <div class="choos_elineup">
            ...
            <div class="tarrif_count-weeks">
                ...
                <div class="count_of_week"
                    ...
                    <button class="sale" v-if="cart[0].choosedRation == 's' && cart[0].timeToEat == 5">
                        <span class="forDesktop">135 бонусов</span>
                        <span class="forMobile">135 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 's' && cart[0].timeToEat == 7">
                        <span class="forDesktop">189 бонусов</span>
                        <span class="forMobile">189 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 'm' && cart[0].timeToEat == 5">
                        <span class="forDesktop">142 бонусов</span>
                        <span class="forMobile">142 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 'm' && cart[0].timeToEat == 7">
                        <span class="forDesktop">+199 бонусов</span>
                        <span class="forMobile">+199 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 'l' && cart[0].timeToEat == 5">
                        <span class="forDesktop">+148 бонусов</span>
                        <span class="forMobile">+148 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 'l' && cart[0].timeToEat == 7">
                        <span class="forDesktop">+207 бонусов</span>
                        <span class="forMobile">+207 б.</span>
                    </button>
                ...
                <div class="count_of_week"
                    ...
                    <button class="sale" v-if="cart[0].choosedRation == 's' && cart[0].timeToEat == 5">
                        <span class="forDesktop">+259 бонусов</span>
                        <span class="forMobile">+259 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 's' && cart[0].timeToEat == 7">
                        <span class="forDesktop">+363 бонусов</span>
                        <span class="forMobile">+363 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 'm' && cart[0].timeToEat == 5">
                        <span class="forDesktop">+271 бонусов</span>
                        <span class="forMobile">+271 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 'm' && cart[0].timeToEat == 7">
                        <span class="forDesktop">+380 бонусов</span>
                        <span class="forMobile">+380 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 'l' && cart[0].timeToEat == 5">
                        <span class="forDesktop">+283 бонусов</span>
                        <span class="forMobile">+283 б.</span>
                    </button>
                    <button class="sale" v-else-if="cart[0].choosedRation == 'l' && cart[0].timeToEat == 7">
                        <span class="forDesktop">+397 бонусов</span>
                        <span class="forMobile">+397 б.</span>
                    </button>
                ...
                {{--                <div class="count_of_week"--}}
                {{--                     @click="cart[0].chosenWeek = 3, checkValues(0, cart[0].choosedRation, cart[0].timeToEat, cart[0].chosenWeek);"--}}
                {{--                     :class="{count_of_week_active:cart[0].chosenWeek == 3}">--}}
                {{--                    <button class="sale" v-if="cart[0].choosedRation == 's' && cart[0].timeToEat == 5">--}}
                {{--                        <span class="forDesktop">+379 бонусов</span>--}}
                {{--                        <span class="forMobile">+379 б.</span>--}}
                {{--                    </button>--}}
                {{--                    <button class="sale" v-else-if="cart[0].choosedRation == 's' && cart[0].timeToEat == 7">--}}
                {{--                        <span class="forDesktop">+531 бонусов</span>--}}
                {{--                        <span class="forMobile">+531 б.</span>--}}
                {{--                    </button>--}}
                {{--                    <button class="sale" v-else-if="cart[0].choosedRation == 'm' && cart[0].timeToEat == 5">--}}
                {{--                        <span class="forDesktop">+388 бонусов</span>--}}
                {{--                        <span class="forMobile">+388 б.</span>--}}
                {{--                    </button>--}}
                {{--                    <button class="sale" v-else-if="cart[0].choosedRation == 'm' && cart[0].timeToEat == 7">--}}
                {{--                        <span class="forDesktop">+544 бонусов</span>--}}
                {{--                        <span class="forMobile">+544 б.</span>--}}
                {{--                    </button>--}}
                {{--                    <button class="sale" v-else-if="cart[0].choosedRation == 'l' && cart[0].timeToEat == 5">--}}
                {{--                        <span class="forDesktop">+409 бонусов</span>--}}
                {{--                        <span class="forMobile">+409 б.</span>--}}
                {{--                    </button>--}}
                {{--                    <button class="sale" v-else-if="cart[0].choosedRation == 'l' && cart[0].timeToEat == 7">--}}
                {{--                        <span class="forDesktop">+571 бонусов</span>--}}
                {{--                        <span class="forMobile">+571 б.</span>--}}
                {{--                    </button>--}}
                {{--                    <div class="count_week" v-if="cart[0].timeToEat == 5">10 <span>дней</span></div>--}}
                {{--                    <div class="count_week" v-else-if="cart[0].timeToEat == 7">14 <span>дней</span></div>--}}
                {{--                    <div class="dishes_per_day" v-if="cart[0].choosedRation == 's'">844 ₽ <span>в день</span></div>--}}
                {{--                    <div class="dishes_per_day" v-else-if="cart[0].choosedRation == 'm'">864 ₽ <span>в день</span></div>--}}
                {{--                    <div class="dishes_per_day" v-else>911 ₽ <span>в день</span></div>--}}
                {{--                </div>--}}
                <div class="count_of_week"
            ...
            <div class="count_dish">
                <div class="dishes_5">
                    ...
                    <span class="old_price"
                          v-if="cart[0].totalPriseFirstNotSale">@{{ cart[0].dishesPriseNotSale }} ₽</span>
                </div>
                <ul>
                    <li class="first_list">@{{ cart[0].deliveryText }}</li>
                    <li class="second_list sale-900-text forDesktop"
                        v-if="cart[0].chosenWeek == 1 || cart[0].chosenWeek == 2">
                        -700₽ на первый заказ по промокоду FIRST
                    </li>
                </ul>
            </div>
            ...
            <button v-if="cart[0].chosenWeek == 4" class="sale sale_-5">
               ...
               <span v-if="cart[0].timeToEat == 7">+7 дней</span>
                    ...
                    <div href="#" @click="modalAction('popap-bonus', false)" class="total_prise popap-link">
                        ...
                        &nbsp&nbsp<span class="apsty_lineSrue " v-if="cart[0].totalPriseFirstNotSale">@{{ cart[0].totalPriseFirstNotSale + excludesInfo.price }} ₽</span>
                        <div v-if="excludesInfo.count" style="line-height: 24px;font-size: 14px;font-weight: 500;">
                            ...
                            excludesInfo.price }}₽ <a style="color: #EB6300;text-decoration: underline;"
                                                      href="javascript:void(0)"
                                                      @click="excludes = {meatAndFish: [],dish: [],vegetables: [],garnishes: [],allergy: []}">Сбросить</a>)
                        </div>
                        <div class="bonus">+ <b>@{{ cart[0].bonus }}</b>
                            ₽ вернём бонусами
                        </div>
                        <span class="sale-900-text forMobile" v-if="cart[0].chosenWeek == 1 || cart[0].chosenWeek == 2">
                            -700₽ на первый заказ по <br> промокоду FIRST
                        </span>
                    </div>
                </div>
