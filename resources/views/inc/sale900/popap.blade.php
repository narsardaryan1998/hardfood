            ...
            <div class="popap__text content-checkout">
                <div v-if="cart[0].chosenWeek != 22">
                    ...
                    <button href="#" @click="modalAction('ordering-popap', 'checkout')"
                            v-if="userData.phone && userData.loggedIn"
                            class="content-checkout__btn popap-link">Оформить на сайте
                    </button>
                    <button href="#" @click="modalAction('order-self', 'checkout')" v-else
                            class="content-checkout__btn popap-link">Оформить на сайте
                    </button>
                </div>
...
<div id="popap-sms" class="popap _popap-sms">
    <div class="popap__body">
        <div class="popap__content">
            <a href="#" class="popap__close close-popup">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="popap__subtitle">
                ...
                <a href="#" @click="modalAction('order-self', 'popap-sms')"
                   class="popap-link">изменить номер</a>
            </div>
            <iframe style="display: none;" name="frame"></iframe>
            <form action="#" target="frame">
                <div class="popap-sms__inputs" style="display: block">
                    <input :class="{'validation-error':wrongSmsCode}" maxlength="4" @keyup="checkSmsCodeLength()"
                           id="smsCodeInput"
                ...
                <button v-else href="#" @click="codeTryInput(false)" type=button class="fast-order__btn">Отправить
                </button>
            </form>
...
<div id="order-self" class="popap _fast-order">
    <div class="popap__body">
        <div class="popap__content">
            <a href="#" class="popap__close close-popup">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="popap__title">
                Введи номер <span>телефона</span>
            </div>
            <div class="popap__subtitle">
                для авторизации на сайте и самостоятельного оформления заказа
            </div>
            <iframe style="display: none;" name="frame"></iframe>
            ...
            <form action="#" target="frame">
                <input v-model="userData.phone" type="tel" class="fast-order__input" v-mask="'+7 (###) ### ## ##'"
                       :class="{'padding-30-desktop':userData.phone.length}"
                       placeholder="+7 (___) ___-__-__">
                <button v-if="userData.phone.length != 18" disabled class="fast-order__btn popap-submit">Далее</button>
                <button v-else href="#" @click="getCodeSmsMethod('popap-sms','order-self')"
                        type="button"
                        class="fast-order__btn popap-submit">Далее
                </button>
            </form>
            <div class="fast-order__subtitle">
                <span>Нажимая кнопку «Далее», ты соглашаешься с</span> условиями оферты <span>и нашей</span> политикой
                конфиденциальности.
            </div>
            <svg class="wawe" width="566" height="78" viewBox="0 0 566 78" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
...
{{--                                  <span v-else-if="cartItem.chosenWeek == 3">3 дней</span>--}}
                                ...
                                <div class="ordering-info__total total-info">
                                    <div class="total-info__price" v-if="cart[0].chosenWeek == 1 || cart[0].chosenWeek == 2">
                                        ...
                                        <div class="total-info__price-nb price-nb"
                                            ...
                                            <div class="price-nb__number">
                                                @{{ orderTotalPrice - userData.balance + excludesInfo.price - 900 }} ₽
                                            </div>
                                            <div class="price-nb__bns">
                                                <del>@{{ orderTotalPrice + excludesInfo.price - 900 }}</del>
                                        ...
                                        <div class="total-info__price-nb price-nb"
                                            ...
                                            <div class="price-nb__number">
                                                @{{ orderTotalPrice - 900 - (orderTotalPrice / 2) + excludesInfo.price}} ₽
                                            </div>
                                            <div class="price-nb__bns">
                                                <del>@{{ orderTotalPrice + excludesInfo.price - 900 }}</del>
                                        ...
                                        <div class="total-info__price-nb price-nb"
                                            ...
                                            <div class="price-nb__number">
                                                @{{ orderTotalPrice - userData.promoCodeSaleCost + excludesInfo.price - 900 }}
                                                ₽
                                            </div>
                                            <div class="price-nb__bns">
                                                <del>@{{ orderTotalPrice + excludesInfo.price -900 }}</del>
                                                <div>@{{ - userData.promoCodeSaleCost - 900 }} ₽</div>
                                            </div>
                                        </div>
                                        <div class="total-info__price-nb price-nb" v-else>
                                            <div class="price-nb__number">
                                                @{{ orderTotalPrice + excludesInfo.price - 900 }} ₽
                                            </div>
                                            <div class="price-nb__bns">
                                    ...
                                    <div class="total-info__price" v-else>
                                        <div class="total-info__title">
                                            Итого
                                        </div>
                                        <div class="total-info__price-nb price-nb"
            ...
            <div v-if="cart[changingOrderIndex]" class="chenge-order__form">
                <form action="#" target="frame">
                    <div class="_labal-container">
                        ...
                        <select id="chenge-rasion default-text-color" v-model="cart[changingOrderIndex].choosedRation"
