<div class="main_title_slider">
    <div class="main_title bunner-2 bunner-first-promocode">
        <div class="main_title_cotent">
            <div class="main_title_icon">
            </div>
            <div class="main_title_content_text">
                <div class="bunner-2__bonus _bonus">
                    <img data-src="/img/bunner/bunner2/01.png" alt="no image">
                    <img data-src="/img/bunner/bunner2/02.png" alt="no image">
                </div>
                <a href="#orderingSection">
                    <span class="_orange">Скидка 700 ₽</span>
                </a>
                на первый заказ <span class="_whiteSpace">от 5-ти дней по промокоду
                    <a @click="copyClipboardPromoCode" href="javascript:void(0)"> <span
                            class="bunner-2__btn">FIRST
            ...
            <div class="bunner-2__btn1">
                <a @click="copyClipboardPromoCode" href="javascript:void(0)">
                    <button class="btn1">Скопировать промокод</button>
                </a>
            </div>
        </div>
    </div>
...
{{--            </div>--}}
{{--            <div class="main_title_content_text">--}}
{{--                <span class="forDesktop"><span class="_orange">Приглашайте</span> друзей и получайте <span class="_orange">бонусы</span></span>--}}
{{--                <p class="forDesktop">--}}
{{--                     себе и другу--}}
...
{{--                        <span style="position: absolute;right: -108px;top: -31px;" class="_orangeBtn forDesktop">+500₽  за друга</span>--}}
{{--                    </a>--}}
{{--                </p>--}}
...
{{--            </div>--}}
{{--        </div>--}}
{{--        <div class="main_title_plate">--}}
{{--            <div class="main_title_plate_plate">--}}
{{--                <img data-src="/img/referral_bunner_dish.png" width="342px">--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
</div>
