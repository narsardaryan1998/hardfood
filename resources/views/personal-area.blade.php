...
<head>
    ...
    <link rel="canonical" href="https://otbabuli.com/personal-area"/>
    <meta property="og:title" content="Личный кабинет | otbabuli.com"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="otbabuli.com"/>
    <meta property="og:url" content="https://otbabuli.com/personal-area"/>
    ...
    <title>Личный кабинет | otbabuli.com</title>
</head>

<body>
@include('inc.preloader')
<div class="personal-area-app">
    @include('inc.loading')
    <div id="personalArea" class="wrapper">
        <div class="conteiner">
            <div class="header">
                @include('inc.header_menu')
            </div>
            @include('inc.cabinet-menus')
            @include('inc.footer')
            @include('inc.personal-area-cabinet.popap')
...
<script type="application/javascript">;(function (a, n, da, ta) {
    ...
    })(window, 'mdeploy.andata.ru', 'ooo-fison_ewixo', 'script');
</script>
<!-- End Andata Code -->
...
<script src="/js/personal-area-script-dist.js?ver=1100064"></script>
